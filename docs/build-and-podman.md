...
- `v1.5.18-wolfi`, `v1.5.18-alpine`, `v1.5.18-suse-micro`, `v1.5.18-debian`
...
- `v1.5.18-cache-wolfi`, `v1.5.18-cache-alpine`,
  `v1.5.18-cache-suse-micro`, `v1.5.18-cache-debian`
- `v1.5.18-proxy-wolfi`, `v1.5.18-proxy-alpine`,
  `v1.5.18-proxy-suse-micro`, `v1.5.18-proxy-debian`
- `v1.5.18-load-balancer-wolfi`, `v1.5.18-load-balancer-alpine`,
  `v1.5.18-load-balancer-suse-micro`, `v1.5.18-load-balancer-debian`
- `v1.5.18-php-wolfi`, `v1.5.18-php-alpine`,
  `v1.5.18-php-suse-micro`, `v1.5.18-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.5.18-cache`, `v1.5.18-proxy`,
  `v1.5.18-load-balancer`, `v1.5.18-php`, `latest-cache`, `latest-proxy`,
