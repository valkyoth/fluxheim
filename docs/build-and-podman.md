...
- `v1.5.16-wolfi`, `v1.5.16-alpine`, `v1.5.16-suse-micro`, `v1.5.16-debian`
...
- `v1.5.16-cache-wolfi`, `v1.5.16-cache-alpine`,
  `v1.5.16-cache-suse-micro`, `v1.5.16-cache-debian`
- `v1.5.16-proxy-wolfi`, `v1.5.16-proxy-alpine`,
  `v1.5.16-proxy-suse-micro`, `v1.5.16-proxy-debian`
- `v1.5.16-load-balancer-wolfi`, `v1.5.16-load-balancer-alpine`,
  `v1.5.16-load-balancer-suse-micro`, `v1.5.16-load-balancer-debian`
- `v1.5.16-php-wolfi`, `v1.5.16-php-alpine`,
  `v1.5.16-php-suse-micro`, `v1.5.16-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.5.16-cache`, `v1.5.16-proxy`,
  `v1.5.16-load-balancer`, `v1.5.16-php`, `latest-cache`, `latest-proxy`,
