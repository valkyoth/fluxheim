...
- `v1.6.27-wolfi`, `v1.6.27-alpine`, `v1.6.27-suse-micro`, `v1.6.27-debian`
...
- `v1.6.27-cache-wolfi`, `v1.6.27-cache-alpine`,
  `v1.6.27-cache-suse-micro`, `v1.6.27-cache-debian`
- `v1.6.27-proxy-wolfi`, `v1.6.27-proxy-alpine`,
  `v1.6.27-proxy-suse-micro`, `v1.6.27-proxy-debian`
- `v1.6.27-load-balancer-wolfi`, `v1.6.27-load-balancer-alpine`,
  `v1.6.27-load-balancer-suse-micro`, `v1.6.27-load-balancer-debian`
- `v1.6.27-php-wolfi`, `v1.6.27-php-alpine`,
  `v1.6.27-php-suse-micro`, `v1.6.27-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.6.27-cache`, `v1.6.27-proxy`,
  `v1.6.27-load-balancer`, `v1.6.27-php`, `latest-cache`, `latest-proxy`,
