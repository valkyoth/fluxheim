...
- `v1.6.29-wolfi`, `v1.6.29-alpine`, `v1.6.29-suse-micro`, `v1.6.29-debian`
...
- `v1.6.29-cache-wolfi`, `v1.6.29-cache-alpine`,
  `v1.6.29-cache-suse-micro`, `v1.6.29-cache-debian`
- `v1.6.29-proxy-wolfi`, `v1.6.29-proxy-alpine`,
  `v1.6.29-proxy-suse-micro`, `v1.6.29-proxy-debian`
- `v1.6.29-load-balancer-wolfi`, `v1.6.29-load-balancer-alpine`,
  `v1.6.29-load-balancer-suse-micro`, `v1.6.29-load-balancer-debian`
- `v1.6.29-php-wolfi`, `v1.6.29-php-alpine`,
  `v1.6.29-php-suse-micro`, `v1.6.29-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.6.29-cache`, `v1.6.29-proxy`,
  `v1.6.29-load-balancer`, `v1.6.29-php`, `latest-cache`, `latest-proxy`,
