...
- `v1.6.9-wolfi`, `v1.6.9-alpine`, `v1.6.9-suse-micro`, `v1.6.9-debian`
...
- `v1.6.9-cache-wolfi`, `v1.6.9-cache-alpine`,
  `v1.6.9-cache-suse-micro`, `v1.6.9-cache-debian`
- `v1.6.9-proxy-wolfi`, `v1.6.9-proxy-alpine`,
  `v1.6.9-proxy-suse-micro`, `v1.6.9-proxy-debian`
- `v1.6.9-load-balancer-wolfi`, `v1.6.9-load-balancer-alpine`,
  `v1.6.9-load-balancer-suse-micro`, `v1.6.9-load-balancer-debian`
- `v1.6.9-php-wolfi`, `v1.6.9-php-alpine`,
  `v1.6.9-php-suse-micro`, `v1.6.9-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.6.9-cache`, `v1.6.9-proxy`,
  `v1.6.9-load-balancer`, `v1.6.9-php`, `latest-cache`, `latest-proxy`,
