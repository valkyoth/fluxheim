...
- `v1.6.3-wolfi`, `v1.6.3-alpine`, `v1.6.3-suse-micro`, `v1.6.3-debian`
...
- `v1.6.3-cache-wolfi`, `v1.6.3-cache-alpine`,
  `v1.6.3-cache-suse-micro`, `v1.6.3-cache-debian`
- `v1.6.3-proxy-wolfi`, `v1.6.3-proxy-alpine`,
  `v1.6.3-proxy-suse-micro`, `v1.6.3-proxy-debian`
- `v1.6.3-load-balancer-wolfi`, `v1.6.3-load-balancer-alpine`,
  `v1.6.3-load-balancer-suse-micro`, `v1.6.3-load-balancer-debian`
- `v1.6.3-php-wolfi`, `v1.6.3-php-alpine`,
  `v1.6.3-php-suse-micro`, `v1.6.3-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.6.3-cache`, `v1.6.3-proxy`,
  `v1.6.3-load-balancer`, `v1.6.3-php`, `latest-cache`, `latest-proxy`,
