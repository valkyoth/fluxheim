...
- `v1.5.15-wolfi`, `v1.5.15-alpine`, `v1.5.15-suse-micro`, `v1.5.15-debian`
...
- `v1.5.15-cache-wolfi`, `v1.5.15-cache-alpine`,
  `v1.5.15-cache-suse-micro`, `v1.5.15-cache-debian`
- `v1.5.15-proxy-wolfi`, `v1.5.15-proxy-alpine`,
  `v1.5.15-proxy-suse-micro`, `v1.5.15-proxy-debian`
- `v1.5.15-load-balancer-wolfi`, `v1.5.15-load-balancer-alpine`,
  `v1.5.15-load-balancer-suse-micro`, `v1.5.15-load-balancer-debian`
- `v1.5.15-php-wolfi`, `v1.5.15-php-alpine`,
  `v1.5.15-php-suse-micro`, `v1.5.15-php-debian`
...
- `latest-cache-wolfi`, `latest-proxy-wolfi`,
  ...
  default branch
- Wolfi short aliases: `v1.5.15-cache`, `v1.5.15-proxy`,
  `v1.5.15-load-balancer`, `v1.5.15-php`, `latest-cache`, `latest-proxy`,
