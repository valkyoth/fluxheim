...
frequency and parallel mode, priority group, max in-flight cap, current
in-flight count, passive failure count, passive ejection, passive ejection
remaining seconds, slow-start allowance, and least-time latency state where
available. In
