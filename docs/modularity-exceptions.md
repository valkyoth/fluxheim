...
| `crates/fluxheim-config/src/config_proxy.rs` | 1451 | Proxy config and validation after auth-request, traffic-mirror, and error-page config moved out. | Split upstream discovery and TLS/upstream policy subdomains. |
