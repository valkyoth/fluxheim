...
| --- | ---: | --- | --- |
| `src/admin.rs` | 5390 | Legacy admin HTTP endpoint router over every domain after basic admin/auth, cache, and load-balancer regression coverage moved to child modules. | Continue splitting admin tests and domain helpers, then evaluate `fluxheim-admin`. |
