...
| `crates/fluxheim-config/src/config_proxy.rs` | 1692 | Proxy config and validation after auth-request config moved out. | Split traffic mirror, error pages, upstream discovery, and TLS/upstream policy subdomains. |
