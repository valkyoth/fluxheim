...
| --- | ---: | --- | --- |
| `src/admin.rs` | 5928 | Legacy admin HTTP endpoint router over every domain after basic admin/auth and cache regression coverage moved to child modules. | Continue splitting admin tests and domain helpers, then evaluate `fluxheim-admin`. |
