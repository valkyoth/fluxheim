...
| `crates/fluxheim-config/src/config_proxy.rs` | 1486 | Proxy config and validation after auth-request and traffic-mirror config moved out. | Split error pages, upstream discovery, and TLS/upstream policy subdomains. |
