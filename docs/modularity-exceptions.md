...
| --- | ---: | --- | --- |
| `crates/fluxheim-config/src/config_tests.rs` | 13664 | Legacy central config regression suite after basic server/process/static-web, compression, GeoIP, and generic header validation coverage moved to focused child modules. | Split by config domain as crates stabilize. |
