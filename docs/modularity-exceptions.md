...
| `src/web.rs` | 1044 | Root static web adapter over `fluxheim-web` after the static body reader moved to a focused child module. | Split static resolution, response planning, and tests into child modules. |
