...
| --- | ---: | --- | --- |
| `crates/fluxheim-config/src/config_tests.rs` | 13835 | Legacy central config regression suite after basic server/process/static-web, compression, and GeoIP coverage moved to focused child modules. | Split by config domain as crates stabilize. |
