...
| `src/metrics.rs` | 3422 | Root metrics registry/export adapter over many domains after native metrics secret loading moved to a focused private module. | Move remaining pure metrics into `fluxheim-observability`. |
