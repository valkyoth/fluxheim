...
| `src/metrics.rs` | 1654 | Root metrics registry/export adapter over many domains after native metrics HTTP app, secret loading, label mapping, and metrics tests moved to focused private modules. | Move remaining pure metrics into `fluxheim-observability`. |
