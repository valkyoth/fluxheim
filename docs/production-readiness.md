...
request/key/admission policy plus fixed-slice range planning; cache storage,
slice object assembly, and the remaining proxy core orchestration stay in scope
