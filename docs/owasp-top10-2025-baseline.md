...
| [A03 Software Supply Chain Failures](https://owasp.org/Top10/2025/A03_2025-Software_Supply_Chain_Failures/) | CI requires `cargo deny check`, `cargo audit`, SBOM generation, registry allow-listing, and FIPS-capable profile validation. |
| [A04 Cryptographic Failures](https://owasp.org/Top10/2025/A04_2025-Cryptographic_Failures/) | TLS FIPS policy rejection tests, TLS storage symlink/permission tests, OpenSSL FIPS-capable validation script, FIPS documentation. |
