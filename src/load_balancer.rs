...
impl MaglevTable {
    fn from_backends(backends: &[Backend]) -> io::Result<Self> {
...
fn configured_maglev_table(config: &ProxyConfig) -> io::Result<MaglevTable> {
...
mod tests {
    ...
    use super::{
        ...
        backend_connection_key, cookie_key, fnv1a64_with_seed, least_connections_score_is_lower,
        request_header_key,
    };
