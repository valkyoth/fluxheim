...
pub use fluxheim_cache::purge_index::{
    CacheIndexedPurgeResult, CachePurgeIndex, CachePurgeIndexEntry, CacheStalePurgeResult,
};
#[cfg(feature = "proxy")]
...
pub use fluxheim_cache::{
    ...
    DiskCacheStats, DiskObjectIndex as FluxDiskObjectIndex, DiskTierPlan, FluxCacheKeyParts,
...
#[cfg(feature = "proxy")]
use fluxheim_cache::{
    DiskCacheObjectKey, MAX_CACHE_TAGS_PER_OBJECT, STORAGE_BIN_DATA_DIR,
    STORAGE_BIN_MANIFEST_FILENAME, StorageBinFreeMap, StorageBinIndexEntry, StorageBinLayoutPlan,
    StorageBinManifest, StorageBinObjectLocation, collect_cache_tags,
...
#[cfg(feature = "proxy")]
type DiskObjectIndex = FluxDiskObjectIndex;
...
mod tests {
    ...
    fn storage_bin_free_map_allocates_and_reuses_ranges() {
        ...
        assert_eq!(
            ...
            &[
                fluxheim_cache::StorageBinFreeRange { offset: 16, len: 8 },
                fluxheim_cache::StorageBinFreeRange {
                    offset: 48,
                    len: 16
                },
            ]
