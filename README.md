...
| Load-balancer status | ✅ | Admin status includes configured pools, backend readiness, policy metadata, disabled/drained state, in-flight counts, passive ejection/remaining time, slow-start, and least-time latency state. |
