...
| Load-balancer status | ✅ | Admin status includes configured pools, selection/health/retry policy metadata, backend readiness, disabled/drained state, in-flight counts, passive failure/ejection state, slow-start, and least-time latency state. |
