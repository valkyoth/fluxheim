...
| Windows portable builds | 🧪 | `1.8.2` is the active native MSVC parity line for x86_64 and ARM64. Native x86_64 CI now passes the workspace, seven profiles, live runtime, archives, and packaged Wasm; archives remain unpublished until the same ARM64 gate and exact-tag reproducibility evidence pass on both architectures. |
