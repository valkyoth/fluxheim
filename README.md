...
events, policy bypasses, and allowed stale serving. The local observability
smoke checks Prometheus/OpenTelemetry export plumbing and cache policy gauges
for request-collapsing coverage.
