...
| Windows portable builds | 🧪 | `1.8.2` is the active native MSVC parity line for x86_64 and ARM64. The seven-profile plan and dedicated-builder automation are defined; archives remain unpublished until native ACL, runtime, live-smoke, and reproducibility gates pass on both architectures. |
