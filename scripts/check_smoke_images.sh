...
inspect_image "Prometheus smoke" "${FLUXHEIM_PROMETHEUS_IMAGE:-docker.io/prom/prometheus:latest}"
inspect_image "Jaeger smoke" "${FLUXHEIM_JAEGER_IMAGE:-docker.io/jaegertracing/all-in-one:latest}"
