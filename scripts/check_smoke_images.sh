...
inspect_image "MariaDB health" "${FLUXHEIM_MYSQL_IMAGE:-docker.io/library/mariadb:12.3}"
inspect_image "PostgreSQL health" "${FLUXHEIM_POSTGRES_IMAGE:-docker.io/library/postgres:18-alpine}"
inspect_image "Valkey health" "${FLUXHEIM_REDIS_IMAGE:-docker.io/valkey/valkey:9.1-alpine}"
